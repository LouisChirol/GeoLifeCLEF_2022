...
def training():
    ...
    def kingdom_training(df_train, df_val, df_env, export_folder="./models/", es=10000, es_th=early_stop_th, lr=0.01):
        ...
        # Put the model in training mode (dropout layers unfreezed)
            ...
            export_model = export_folder + "model_effnet_rgnirland_sch_epoch_"+str(epoch)+".pth"
            ...
            export_loss_png = export_folder+"loss_effnet_rgnirland_sch_epochs_"+str(epochs)+"_batch_size_"+str(batch_size)+".png"
...
def prediction():
    ...
    # Load models
    model_faune.cnn.load_state_dict(torch.load("./models/faune/model_effnet_rgnirland_sch_epoch_1.pth").state_dict())
    model_flore.cnn.load_state_dict(torch.load("./models/flore/model_effnet_rgnirland_sch_epoch_0.pth").state_dict())

...
def training():
    ...
    # Data loader call
    train_data = ImageData(df = df_train.iloc[:300], data_path = DATA_PATH, load = load_patch, landcover_mapping=landcover_mapping)
    ...
    for epoch in range(epochs):    
        ...
        with tqdm(enumerate(train_loader), total=300/batch_size) as tepoch:
        ...
        # plt.subplot(232)
        # plt.plot(x_train, acc_log_train, label="train_acc per batch")
        # plt.legend()
        ...
        # plt.subplot(233)
        # plt.plot(x_train, list_top_30_train, label="train_top_30_error per batch")
        # plt.legend()
